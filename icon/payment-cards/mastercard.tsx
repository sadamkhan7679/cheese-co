  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M18.25 6.64917C19.7172 7.9153 20.6476 9.79929 20.6476 11.9031C20.6476 14.0069 19.7172 15.8909 18.25 17.157C16.7829 15.8909 15.8525 14.0069 15.8525 11.9031C15.8525 9.79929 16.7829 7.9153 18.25 6.64917Z"
        fill="#FF5E00"
      />
    </svg>
  );
